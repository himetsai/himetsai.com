    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex md:flex-row flex-col w-full items-center justify-between mb-2">
        <div className="flex flex-col p-2">
          ...
          <p className="font-normal text-[#594a4e] leading-7 tracking-wider mt-2 md:max-w-[80%]">
            {incident.description}
          </p>
        </div>

        {incident.image && (
          <div className="relative shrink-0 float-right w-full md:w-80 aspect-[4/5] md:my-5 my-1 md:ml-2">
            <Image
